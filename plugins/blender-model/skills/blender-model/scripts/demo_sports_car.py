...
def palette():
    return dict(
        ...
        trim=lib.hexmat('car_trim', 0x2A2C30, rough=0.70),
                # Warm rather than white, and lit only enough to glint. At full
        # emission the pair of them clip to pure white and become the largest
        # high-contrast feature on the car once it is a dozen pixels long,
        # which is a lamp winning an argument it should not be in.
        lamp=lib.hexmat('car_lamp', 0xF7E4B4, rough=0.20, emissive=0.55),
